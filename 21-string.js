...
// //tamanho de um string (metodo length)

// var texto4 = "Olá, meu nome é Pedro";
// console.log(`tamanho do tetxo: ${texto4.length} caracteres!`);

// //Caracteres de escape
// var texto5 = "Olá, meu nome é \"Pedro\"!";
// console.log(texto5);
...
// //obtendo partes de uma string (metdo substring)
// var texto8 = "O esperto rato, perplexo ficou frebre ao aparto"
// var sub = texto8.substring(16,24) // posição onde comeca e onde termina
// console.log(sub)
